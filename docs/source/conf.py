...
# kotari_gender_data_analysis documentation build
...
from kotari_gender_data_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "kotari_gender_data_analysis"
author = "Kedro"
...
htmlhelp_basename = "kotari_gender_data_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "kotari_gender_data_analysis.tex",
        "kotari_gender_data_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kotari_gender_data_analysis",
        "Project kotari_gender_data_analysis codebase.",
        "Data-Science",
    )
]
